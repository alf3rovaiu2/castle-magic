...
left_bottom_corner_dirt2 = pygame.image.load('data/images/tiles/bottom_corner_dirt2.png').convert_alpha()
...
while True:
    ...
    if load_game_menu:
        ...
        back_button = Button(1250, 780, 300, 100, (75, 160, 173), "Back", (0, 0, 0), pixel_font_large)
